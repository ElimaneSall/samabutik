...
public class OrderItemTestSamples {
    ...
    public static OrderItem getOrderItemSample1() {
        return new OrderItem().id(1L).productName("productName1").productSku("productSku1").quantity(1);
    }

    public static OrderItem getOrderItemSample2() {
        return new OrderItem().id(2L).productName("productName2").productSku("productSku2").quantity(2);
    }
