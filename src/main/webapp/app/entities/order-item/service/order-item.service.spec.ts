...
describe('OrderItem Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a OrderItem', () => {
      ...
      service.create(orderItem).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a OrderItem', () => {
      ...
      service.update(orderItem).subscribe(resp => (expectedResult = resp));
    ...
    describe('addOrderItemToCollectionIfMissing', () => {
      it('should add a OrderItem to an empty array', () => {
        ...
        expect(expectedResult).toEqual([orderItem]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([orderItem, orderItem2]);
      });
