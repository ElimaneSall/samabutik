...
describe('Pack Management Detail Component', () => {
  let comp: PackDetail;
  let fixture: ComponentFixture<PackDetail>;
      ...
      providers: [
        provideRouter(
          [
            {
              path: '**',
              loadComponent: () => import('./pack-detail').then(m => m.PackDetail),
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PackDetail);
  ...
  describe('OnInit', () => {
    it('should load pack on init', async () => {
      ...
      const instance = await harness.navigateByUrl('/', PackDetail);
