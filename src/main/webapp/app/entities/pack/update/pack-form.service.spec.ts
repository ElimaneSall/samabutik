...
import { sampleWithNewData, sampleWithRequiredData } from '../pack.test-samples';
  ...
  describe('Service methods', () => {
      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            displayOnHomepage: expect.any(Object),
            mainMedia: expect.any(Object),
          }),
        );
      });
    ...
    describe('getPack', () => {
      it('should return NewPack for default Pack initial value', () => {
        ...
        const pack = service.getPack(formGroup);
