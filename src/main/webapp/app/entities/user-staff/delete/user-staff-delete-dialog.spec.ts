...
import { UserStaffDeleteDialog } from './user-staff-delete-dialog';

describe('UserStaff Management Delete Component', () => {
  let comp: UserStaffDeleteDialog;
  let fixture: ComponentFixture<UserStaffDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(UserStaffDeleteDialog);
