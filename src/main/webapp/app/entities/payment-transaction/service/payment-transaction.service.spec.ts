...
const requireRestSample: RestPaymentTransaction = {
  ...
  processedAt: sampleWithRequiredData.processedAt?.toJSON(),
};
...
describe('PaymentTransaction Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a PaymentTransaction', () => {
      ...
      service.create(paymentTransaction).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a PaymentTransaction', () => {
      ...
      service.update(paymentTransaction).subscribe(resp => (expectedResult = resp));
    ...
    describe('addPaymentTransactionToCollectionIfMissing', () => {
      it('should add a PaymentTransaction to an empty array', () => {
        ...
        expect(expectedResult).toEqual([paymentTransaction]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([paymentTransaction, paymentTransaction2]);
      });
