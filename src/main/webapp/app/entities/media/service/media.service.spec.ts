...
describe('Media Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Media', () => {
      ...
      service.create(media).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Media', () => {
      ...
      service.update(media).subscribe(resp => (expectedResult = resp));
    ...
    describe('addMediaToCollectionIfMissing', () => {
      it('should add a Media to an empty array', () => {
        ...
        expect(expectedResult).toEqual([media]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([media, media2]);
      });
